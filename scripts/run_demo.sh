...
CAMERA_V4L2_CONTROLS="${CAMERA_V4L2_CONTROLS:-brightness=32,gain=80,gamma=180,backlight_compensation=6,contrast=32,saturation=55,auto_exposure=3,exposure_dynamic_framerate=1}"
